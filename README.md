...
> **Status:** the modules of the first release (0.1) are written: extraction of sentences, words and character N-grams, syllabification and stress, basic statistics, readability with presets and lexical diversity. The release itself is pending a QA pass and publication on PyPI.
