...
* **[Conjuntos de datos](https://sergeyshk.github.io/esTS/es/datasets/spanishliterature/)** - literatura en español de dominio público: 150 obras de 33 autores de España, Hispanoamérica y Filipinas en prosa, poesía, teatro y ensayo, con el género, los años y el país; 4306 sonetos de los siglos XV-XX con el patrón métrico y la rima de cada verso; un diccionario de frecuencias de 83 785 lemas según Google Books Ngram con ipm, rango y dispersión
...
*   [spanish_sonnets](https://sergeyshk.github.io/esTS/es/datasets/spanishsonnets/) - sonetos en español del Diachronic Spanish Sonnet Corpus (DISCO) de dominio público: 4306 sonetos de 1197 autores de los siglos XV-XX, cada verso con su patrón métrico y la etiqueta de su rima, la anotación automática de DISCO (CC BY 4.0)
