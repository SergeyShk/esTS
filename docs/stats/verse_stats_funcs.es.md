...
4.  **El metro.** El metro de un poema es la medida de la mayoría de las lecturas llanas. Cada verso se ajusta a él con los menos cambios de su lectura llana: un verso más largo une dos vocales de un hiato en una palabra - la sinéresis (*poe-ta*), las que tienen una `i` o una `u` con tilde (*dí-a*) al final; uno más corto deshace sus sinalefas desde el final del verso - el hiato, y después divide un diptongo de una sílaba acentuada - la diéresis (*su-a-ve*, *ru-i-do*, *con-fi-a-do*). Un verso que no alcanza el metro conserva su lectura llana y cuenta como fuera de él.
